            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                {state.result.pdf_url && (
                  <a
                    href={state.result.pdf_url}
                    download
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-medium text-sm transition-all duration-200"
                  >
                    Download PDF
                  </a>
                )}
                {state.result.tex_url && (
                  <a
                    href={state.result.tex_url}
                    download
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-600 hover:bg-slate-500 text-white font-medium text-sm transition-all duration-200"
                  >
                    Download LaTeX
                  </a>
                )}
