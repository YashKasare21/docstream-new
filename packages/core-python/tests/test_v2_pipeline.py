...
def sample_document() -> dict:
    ...
    return {
        ...
        "structure": [
            {"type": "heading", "text": "Test Paper Title", "level": 1, "page": 1},
            {"type": "paragraph", "text": "This is the abstract.", "page": 1},
            {"type": "heading", "text": "Introduction", "level": 2, "page": 1},
            {"type": "paragraph", "text": "This is the introduction.", "page": 1},
            {"type": "heading", "text": "Conclusion", "level": 2, "page": 1},
            {"type": "paragraph", "text": "This is the conclusion.", "page": 1},
        ],
...
class TestGenerator:
    ...
    def test_prompt_contains_content(self, sample_document):
        ...
        from docstream.core.generator import _build_prompt, _load_instructions, _load_skeleton

        skeleton = _load_skeleton("report")
        instructions = _load_instructions("report")
        prompt = _build_prompt(sample_document, skeleton, instructions, "report")
...
class TestCompiler:
    ...
    def test_raises_when_xelatex_missing(self, mock_available, tmp_path):
...
class TestPublicAPI:
    ...
    def test_convert_returns_result(self, minimal_pdf, tmp_path):
        ...
        with patch("docstream.core.compiler._xelatex_available", return_value=False):
    ...
    def test_generate_returns_latex(self, sample_document):
        ...
        mock_ai = MagicMock()
        mock_ai.complete.return_value = VALID_LATEX
        result = docstream.generate(sample_document, "report", mock_ai)
        assert "\\documentclass" in result
